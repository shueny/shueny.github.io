  ...
  projects: {
    ...
    list: [
      ...
      },
      {
        ...
        description: [
          'A Vue 3 + Pinia daily planner that pairs a todo list with a full-screen Pomodoro focus timer. Started years ago as my first Vue learning project, rebuilt from the ground up.',
          'Day-card carousel: one card per day, swipeable via CSS scroll-snap with zero dependencies, synced with day pills and a collapsible monthly calendar hidden behind the header date.',
          'Calendar cells carry status dots (open, overdue, all done), and every day is tappable, including empty ones, to jump and add tasks there.',
          'Task creation includes a date chip that defaults to the day currently in view, so adding to tomorrow needs no extra taps.',
          'Starting a Pomodoro takes over the whole screen: countdown, progress ring, pause and stop, and deliberately nothing else. Blocking distraction is the feature, not a limitation.',
        ],
        image: '/images/vue-todo.jpg',
        url: 'https://shueny.github.io/vue-daily-tomato-todo/',
        technologies: ['Vue 3', 'Pinia', 'CSS Scroll Snap', 'ES6'],
      },
      {
  ...
  specialExperiences: [
    ...
    },
    {
      ...
      description: [
        ...
        'Navigated local transportation systems across both countries, from buses to boats and documented the journey through photography',
      ],
