...
// export const notionTagFields = graphql`
//   fragment notionTagFields on notionTag {
//     slug
//     name
//     visibility
//     feature_image
...
// export const notionAuthorFields = graphql`
//   fragment notionAuthorFields on notionAuthor {
//     slug
//     name
//     bio
//     cover_image
...
export const notionPostFields = graphql`
  fragment notionPostFields on NotionPost {
    # Main fields
    id
    title
    slug
...
export const notionPageFields = graphql`
  fragment notionPageFields on notionPage {
    # Main fields
    title
    slug
    featured
...
// Used for settings
export const notionSettingsFields = graphql`
  fragment notionSettingsFields on notionSettings {
    title
    description
    logo
    icon
