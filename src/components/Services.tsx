  ...
  const services = [
    {
      ...
      desc:
        'Building custom AI tutors, assistants, and automation flows using OpenAI/Gemini APIs.',
      icon: (
        <svg
    ...
    },
    {
      ...
      desc:
        'Scalable React/Next.js/Nuxt.js applications tailored for high performance and growth.',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      desc:
        'Digitizing workflows (e.g., Expense Reporting, CMS Automation) to reduce manual effort.',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      desc:
        'Pixel-perfect implementation from Figma into responsive, interactive code.',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
